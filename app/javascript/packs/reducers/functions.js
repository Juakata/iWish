  ...
  switch (action.type) {
    case OPEN_MENU:
      ...
      if (open) {
        ...
        document.querySelector('.hide').style.webkitClipPath = 'polygon(0 0%, 100% 0, 100% 100%, 0 100%)';
        ...
        document.querySelector('.hide').style.webkitClipPath = 'polygon(0 0%, 100% 0, 100% 0%, 0 0%)';
